...
-- function checkMinstrel(unitType)
-- 	if(unitType=="LOC_UNIT_WANDERING_MINSTREL_NAME") then
-- 		if(not silent) then
-- 			print("It was a minstrel");
-- 		end
-- 		return true;
-- 	end
-- end

-- function lvlMinstrel()

-- end

-- function fixMinstrel(unit)
-- 	print("Unit Activated: " .. unit:GetName());
-- 	-- if(checkMinstrel(unit:GetUnitType()))
-- end
...
-- Events.UnitActivate.Add(fixMinstrel);
-- print("Minstrel Script Loaded.");
